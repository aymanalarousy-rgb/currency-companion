  ...
  return (
    <div className="min-h-screen bg-background text-foreground p-6 max-w-3xl mx-auto" dir="rtl">
      ...
      <div className="space-y-6 text-sm leading-relaxed">
        ...
        <section>
          <h2 className="text-lg font-semibold mb-2">الإعلانات والمعرّف الإعلاني</h2>
          <p>
            يحتوي هذا التطبيق على إعلانات يتم عرضها من خلال خدمة Google AdMob.
            يستخدم التطبيق المعرّف الإعلاني (Advertising ID / AD_ID) للأغراض التالية:
          </p>
          <ul className="list-disc list-inside mt-2 space-y-1 text-muted-foreground">
            <li>عرض الإعلانات داخل التطبيق (إعلانات بانر وإعلانات بينية)</li>
            <li>تحليل أداء الإعلانات وقياس فعاليتها</li>
            <li>تقديم إعلانات مخصصة بناءً على اهتمامات المستخدم</li>
            <li>إحصاءات الاستخدام لتحسين تجربة التطبيق</li>
          </ul>
          <p className="mt-2">
            قد تستخدم خدمات الإعلانات ملفات تعريف الارتباط أو معرّفات الأجهزة لتقديم إعلانات ملائمة.
            يمكنك إلغاء الاشتراك في الإعلانات المخصصة من خلال إعدادات جهازك.
            يمكنك الاطلاع على سياسة خصوصية Google من خلال:
          </p>
          <a
